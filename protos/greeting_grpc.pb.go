...
func (c *greetingServiceClient) Greet(ctx context.Context, in *Name, opts ...grpc.CallOption) (*Greeting, error) {
	out := new(Greeting)
	err := c.cc.Invoke(ctx, "/protos.GreetingService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreetingServiceServer) Greet(context.Context, *Name) (*Greeting, error) {
...
func _GreetingService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.GreetingService/Greet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetingServiceServer).Greet(ctx, req.(*Name))
	}
...
var GreetingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protos.GreetingService",
	...
	Metadata: "protos/greeting.proto",
}
